...
import {
  ...
  segundosAtuais,
  formatarTempo,
  placarBroadcastEscalacao3
} from '../store/placarBroadcastEscalacao3Store'
import { PainelEscalacaoBroadcast3 } from '../components/PainelEscalacaoBroadcast3'
...
function PainelTimes() {
  const estado = usePlacarBroadcast(placarBroadcastEscalacao3)
