...
const PreviewSep = styled.div`
  ...
  align-items: center;
  padding: 8px 12px;
  background: linear-gradient(135deg, #ff7a52 0%, #ff4b44 100%);
  font-size: 0.85rem;
  font-weight: 800;
  color: #ffffff;
`;
      ...
      <PreviewBarra>
        <PreviewLinhaTempo>
          ...
          <PreviewChipTempo>
            {tempo}
            {estado.acrescimo > 0 && (
              <PreviewChipAcrescimo>+{estado.acrescimo}:00</PreviewChipAcrescimo>
            )}
          </PreviewChipTempo>
        </PreviewLinhaTempo>
      <div
...
export default function ControlePlacarBroadcast() {
  return (
    <Container>
      <Header subtitulo="Controle · Placar LaLiga" />
      <PreviewLive />
      <Conteudo>
        <PainelTimes />
