...
const ChipPeriodo = styled.button`
  ...
  color: ${({ $ativo, theme }) =>
    $ativo ? '#052e13' : theme.cores.textoSuave};
  border-radius: 999px;
  padding: 9px 16px;
  font-size: 0.75rem;
  font-weight: 700;
...
export default function ControlePlacar() {
  return (
    <Container>
      <Header subtitulo="Controle · Placar de Futebol" />
      <Conteudo>
        <PainelTimes />
