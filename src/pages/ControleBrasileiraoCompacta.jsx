...
export default function ControleBrasileiraoCompacta() {
  const estado = usePlacarBroadcast(brasilieraCompacta);

  return (
    <Container>
      <Header subtitulo="Controle · Tabela Compacta Brasileirão" />
      <Conteudo>
        <Cartao>
          <Titulo>
            <span>●</span> Tabela Compacta · Brasileirão
          </Titulo>
          ...
          <LinhaOpcao>
            <div className="texto">
              ...
              <span className="desc">
                Mostra à esquerda os 10 primeiros e à direita os 10 últimos.
              </span>
            </div>
            <input
              type="checkbox"
        ...
        <PreviaOverlay rota="/brasileirao-compacta" altura={420} />
      </Conteudo>
    </Container>
  );
}
