...
import {
  ...
  segundosAtuais,
  formatarTempo,
  placarBroadcastEscalacao2
} from '../store/placarBroadcastEscalacao2Store'
import { PainelEscalacaoBroadcast2 } from '../components/PainelEscalacaoBroadcast2'
...
function PainelTimes() {
  const estado = usePlacarBroadcast(placarBroadcastEscalacao2)
...
export default function ControlePlacarBroadcastEscalacao2() {
  useDocumentoJogo(placarBroadcastEscalacao2)
  return (
    <Container>
      <Header subtitulo="Controle · Placar Broadcast + Escalação 2" />
      <Conteudo>
        <Secao>
