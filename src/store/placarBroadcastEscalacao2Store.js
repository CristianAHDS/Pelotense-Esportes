...
const STORAGE_KEY = 'pelotense:broadcast-escalacao-2:v1'
const CHANNEL_NAME = 'broadcast:sync-broadcast-escalacao-2-v1'
const MSG_TIPO = 'estado:broadcast-escalacao-2:v1'
const CANAL_NUVEM = 'placar-broadcast-escalacao-2'
...
function carregar() {
  try {
    ...
    console.warn('PlacarEscalacao2: falha ao carregar estado.', e)
  }
...
function persistir() {
  try {
    ...
    console.warn('PlacarEscalacao2: falha ao persistir estado.', e)
  }
}
...
window.addEventListener('storage', (evento) => {
  if (evento.key === STORAGE_KEY && evento.newValue) {
    try {
      ...
      console.warn('PlacarEscalacao2: falha ao sincronizar via storage.', e)
    }
  }
})
...
export const placarBroadcastEscalacao2 = {
  getEstado,
  inscrever
}